...
public class PrecedenciaController extends BaseController {
    ...
    @PostMapping
    public ResponseEntity<ResponseBody> create(@RequestBody Precedencia entidade) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseBody> edit(@PathVariable("id") Integer id, @RequestBody Precedencia entidade) {
